...
public class StartupActivity extends Activity
{
	...
	public void finishDialogNoBluetooth()
	{
		...
		builder.setMessage(R.string.no_bt).setIcon(android.R.drawable.ic_dialog_info).setTitle(R.string.app_name)
				.setCancelable(false).setPositiveButton(R.string.bt_ok, new DialogInterface.OnClickListener()
				{
	...
	{
		EmailManager
				.email(this, "dave@mslogger.co.uk", null, "Unrecognised firmware signature",
