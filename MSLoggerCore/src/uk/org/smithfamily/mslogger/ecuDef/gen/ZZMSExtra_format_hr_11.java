 ...
 */
public class ZZMSExtra_format_hr_11 extends Megasquirt
{
	public ZZMSExtra_format_hr_11(Context c)
	{
		super(c);
	...
	private String[]	defaultGauges	= { "RpmHiResGauge", "cltGauge", "pulseWidth1Gauge", "dutyCycle1Gauge", "loadGauge",
			"baroGauge", "afrGauge", "advanceGauge" };
	...
	public void calculate(byte[] ochBuffer) throws IOException
	{
		...
		else if (AEM_NON_LINEAR)
		{
			...
			lambda = (afr / 14.7);
			TargetAFR = (8.44350 + (afrtarget * (0.0102541 + afrtarget
					* (0.000192111 + afrtarget * (-0.00000138363 + afrtarget * 0.00000000442977)))));
			TargetLambda = (TargetAFR / 14.7);
		}
		else if (NGK_AFX)
		{
	...
	public void initGauges()
	{
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("deadGauge", "deadValue", deadValue, "---", "", 0, 1, -1, -1, 2, 2, 0, 0,
				0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("baroADCGauge", "baroADC", baroADC, "Barometer ADC", "", 0, 255, -1, -1,
				256, 256, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("mapADCGauge", "mapADC", mapADC, "MAP ADC", "", 0, 255, -1, -1, 256, 256,
				0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("matADCGauge", "matADC", matADC, "MAT ADC", "", 0, 255, -1, -1, 256, 256,
				0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("cltADCGauge", "cltADC", cltADC, "CLT ADC", "", 0, 255, -1, -1, 256, 256,
				0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("tpsADCGauge", "tpsADC", tpsADC, "TPS ADC", "", 0, 255, -1, -1, 256, 256,
				0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("batADCGauge", "batADC", batADC, "BAT ADC", "", 0, 255, -1, -1, 256, 256,
				0, 0, 0));
		if (NARROW_BAND_EGO)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoGauge", "egoVoltage", egoVoltage, "Rear Bank O2 Voltage", "volts",
					0, 1.0, 0.2, 0.3, 0.6, 0.8, 2, 2, 0));
		}
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoGauge", "egoVoltage", egoVoltage, "Rear Bank O2 Voltage", "volts",
					0.5, 4.5, 0.0, 0.0, 5.0, 5.0, 2, 2, 0));
		}
		if (NARROW_BAND_EGO)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("ego2Gauge", "ego2Voltage", ego2Voltage, "Front Bank O2 Voltage",
					"volts", 0, 1.0, 0.2, 0.3, 0.6, 0.8, 2, 2, 0));
		}
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("ego2Gauge", "ego2Voltage", ego2Voltage, "Front Bank O2 Voltage",
					"volts", 0.5, 4.5, 0.0, 0.0, 5.0, 5.0, 2, 2, 0));
		}
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("lambdaGauge", "lambda", lambda, "Lambda", "", 0.5, 1.5, 0.5, 0.7, 2, 1.1,
				2, 2, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("accelEnrichGauge", "accDecEnrich", accDecEnrich, "AE Driven Fuel Pct",
				"Pct", 100, 200, 0, 0, 999, 999, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afrGauge", "afr", afr, "Air:Fuel Ratio", "", 10, 19.4, 12, 13, 15, 16, 2,
				2, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("clockGauge", "secl", secl, "Clock", "Seconds", 0, 255, 10, 10, 245, 245,
				0, 0, 0));
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dutyCycle2Gauge", "dutyCycle2", dutyCycle2, "Duty Cycle 2", "%", 0, 100,
				-1, -1, 85, 90, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge", "egoCorrection", egoCorrection,
				"O2 Driven Correction (GEGO)", "%", 80, 120, 90, 99, 101, 110, 0, 0, 0));
		...
		if (MPXH6300A)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("mapGauge", "map", map, "Engine MAP", "kPa", 0, 304, 0, 20, 250, 275,
					0, 0, 0));
		}
		else if (MPXH6400A)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("mapGauge", "map", map, "Engine MAP", "kPa", 0, 400, 0, 20, 250, 275,
					0, 0, 0));
		}
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("mapGauge", "map", map, "Engine MAP", "kPa", 0, 255, 0, 20, 200, 245,
					0, 0, 0));
		}
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("baroGauge", "barometer", barometer, "Barometer", "kPa", 60, 110, 0, 20,
				200, 245, 0, 0, 0));
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("throttleGauge", "throttle", throttle, "Throttle Position", "%TPS", 0,
				100, -1, 1, 90, 100, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("veGauge", "veCurr", veCurr, "VE Current", "%", 0, 120, -1, -1, 999, 999,
				0, 0, 0));
		...
		if (CELSIUS)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("cltGauge", "coolant", coolant, "Coolant Temp", "%TEMP", -40, 120,
					-15, 0, 95, 105, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("matGauge", "mat", mat, "Manifold Air Temp", "%TEMP", -40, 110, -15,
					0, 95, 100, 0, 0, 0));
		}
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("cltGauge", "coolant", coolant, "Coolant Temp", "%TEMP", -40, 250, 0,
					0, 200, 220, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("matGauge", "mat", mat, "Manifold Air Temp", "%TEMP", -40, 215, 0, 0,
					200, 210, 0, 0, 0));
		}
		...
		if (CELSIUS)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge", "egttemp", egttemp, "EGT", "C", 0, 1000, 0, 0, 1450, 1480,
					1, 1, 0));
		}
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge", "egttemp", egttemp, "EGT", "F", 0, 2200, 0, 0, 1450, 1480,
					1, 1, 0));
		}
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afrGauge2", "afr2", afr2, "Air:Fuel Ratio2", "", 10, 19.4, 12, 13, 15,
				16, 2, 2, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vacuumGauge", "vacuum", vacuum, "Engine Vacuum", "in-HG", 0, 30, 0, 0,
				30, 30, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("boostgauge", "boost", boost, "Engine Boost", "PSIG", 0, 20, 0, 0, 15, 20,
				1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("VacBooGauge", "boostVac", boostVac, "Engine Vac Boost", "in-HG/PSIG",
				-30, 30, -30, -30, 30, 30, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("TargetAFRGauge", "TargetAFR", TargetAFR, "Target AFR", "AFR", 10, 19.4,
				0, 0, 20, 20, 2, 2, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("RealDutyGauge1", "dutyCy1Real", dutyCy1Real, "Fuel Delivery 1", "Flow",
				0, 75, -1, -1, 75, 75, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("RealDutyGauge2", "dutyCy2Real", dutyCy2Real, "Fuel Delivery 2", "Flow",
				0, 75, -1, -1, 75, 75, 1, 1, 0));
		if (MPXH6300A)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("loadGauge", "engineLoad", engineLoad, "Load", " % ", 0, 304, 0, 20,
					250, 275, 0, 0, 0));
		}
		else if (MPXH6400A)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("loadGauge", "engineLoad", engineLoad, "Load", " % ", 0, 400, 0, 20,
					300, 375, 0, 0, 0));
		}
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("loadGauge", "engineLoad", engineLoad, "Load", " % ", 0, 255, 0, 20,
					200, 245, 0, 0, 0));
		}
	...
	public void loadConstants(boolean simulated)
	{
		...
		pageBuffer = loadPage(2, 189, 189, new byte[] { 80, 2 }, new byte[] { 86 });
		if (SPEED_DENSITY)
		{
			if (MPXH6300A)
			{
		...
		pageBuffer = loadPage(3, 378, 189, new byte[] { 80, 3 }, new byte[] { 86 });
		if (SPEED_DENSITY)
		{
			if (MPXH6300A)
			{
		...
		pageBuffer = loadPage(4, 567, 189, new byte[] { 80, 0 }, new byte[] { 86 });
		...
		pageBuffer = loadPage(5, 756, 189, new byte[] { 80, 4 }, new byte[] { 86 });
		if (SPEED_DENSITY)
		{
			if (MPXH6300A)
			{
		...
		pageBuffer = loadPage(6, 945, 189, new byte[] { 80, 5 }, new byte[] { 86 });
		if (SPEED_DENSITY)
		{
			if (MPXH6300A)
			{
