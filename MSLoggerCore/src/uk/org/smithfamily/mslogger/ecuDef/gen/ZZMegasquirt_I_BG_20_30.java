...
public class ZZMegasquirt_I_BG_20_30 extends Megasquirt
{
	...
	private String[]	defaultGauges	= { "tachometer", "throttleGauge", "tpsADCGauge", "pulseWidthGauge", "dutyCycleGauge",
			"mapGauge", "matGauge", "cltGauge", "gammaEnrichGauge" };
	...
	public void initGauges()
	{
		...
		if (NARROW_BAND_EGO)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoGauge", "egoVoltage", egoVoltage, "Exhaust Gas Oxygen", "volts",
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("deadGauge", "deadValue", deadValue, "---", "", 0, 1, -1, -1, 2, 2, 0, 0,
				0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dutyCycleGauge", "dutyCycle", dutyCycle, "Duty Cycle", "%", 0, 100, -1,
				-1, 85, 90, 1, 1, 0));
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("mapGauge", "map", map, "Engine MAP", "kPa", 0, 255, 0, 20, 200, 245, 0,
				0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthGauge", "pulseWidth", pulseWidth, "Pulse Width", "mSec", 0,
				25.5, 1.0, 1.2, 20, 25, 1, 1, 0));
		...
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("cltGauge", "coolant", coolant, "Coolant Temp", "%TEMP", -40, 250, 0,
					30, 200, 220, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("matGauge", "mat", mat, "Manifold Air Temp", "%TEMP", -40, 215, 0, 30,
					200, 210, 0, 0, 0));
		}
