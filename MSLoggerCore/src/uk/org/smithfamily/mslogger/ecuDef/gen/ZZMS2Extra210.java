...
public class ZZMS2Extra210 extends Megasquirt
{
	...
	private Set<String>	sigs			= new HashSet<String>(Arrays.asList(new String[] { signature, "MS2Extra Rel 2.1.0q\0",
			"MS2Extra Rel 2.1.0q\0"	}));
	// Flags
	boolean				EGTFULL;
	...
	public void initGauges()
	{
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("gpioadc7Gauge", "gpioadc7", gpioadc7, "GPIO ADC 7", "", 0, 1023, 1023,
				1023, 1023, 1023, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dbgcrkmaskGauge", "dbg_crk_mask", dbg_crk_mask, "Crank masked", "", 0,
				255, 255, 255, 255, 255, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dbgcrkfiltGauge", "dbg_crk_filt", dbg_crk_filt, "Crank filtered", "", 0,
				255, 255, 255, 255, 255, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dbgcammaskGauge", "dbg_cam_mask", dbg_cam_mask, "Cam masked", "", 0, 255,
				255, 255, 255, 255, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dbgcamfiltGauge", "dbg_cam_filt", dbg_cam_filt, "Cam filtered", "", 0,
				255, 255, 255, 255, 255, 0, 0, 0));
