...
public class ZZMS2Extra_Rev_102 extends Megasquirt
{
	...
	private String[]	defaultGauges	= { "tachometer", "EAEGauge", "pulseWidth1Gauge", "cltGauge", "advdegGauge",
	...
	public void initGauges()
	{
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("EAEGauge", "EAEFuelCorr", EAEFuelCorr, "EAE Fuel Correction", "%", 0,
	...
	public void loadConstants(boolean simulated)
	{
		...
		pageBuffer = loadPage(3, 2048, 1024, null, new byte[] { 114, 0, 7, 8, 0, 4, 0 });
