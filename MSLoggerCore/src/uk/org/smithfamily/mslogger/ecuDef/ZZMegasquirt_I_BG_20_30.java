...
public class ZZMegasquirt_I_BG_20_30 extends Megasquirt
{
    ...
    private String[]    defaultGauges = { "tachometer", "throttleGauge", "tpsADCGauge", "pulseWidthGauge", "dutyCycleGauge", "mapGauge", "matGauge",
            "cltGauge", "gammaEnrichGauge" };
    ...
    public void initGauges()
    {
        ...
        if (NARROW_BAND_EGO)
        {
            GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoGauge", "egoVoltage", egoVoltage, "Exhaust Gas Oxygen", "volts", 0, 1.0, 0.2, 0.3, 0.6, 0.8,
                    2, 2, 0));
        }
        else
        {
            GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoGauge", "egoVoltage", egoVoltage, "Exhaust Gas Oxygen", "volts", 0.5, 4.5, 0.0, 0.0, 5.0, 5.0,
                    2, 2, 0));
        }
        ...
        GaugeRegister.INSTANCE
                .addGauge(new GaugeDetails("pulseWidthGauge", "pulseWidth", pulseWidth, "Pulse Width", "mSec", 0, 25.5, 1.0, 1.2, 20, 25, 1, 1, 0));
