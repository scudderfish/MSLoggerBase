 ...
 */
public class ZZMS3_Format_0221002 extends Megasquirt
{
	...
	private String[]	defaultGauges	= { "tachometer", "throttleGauge", "pulseWidth1Gauge", "cltGauge", "advdegGauge",
			"fuelloadGauge", "egoGauge", "lambda1Gauge", "afr1Gauge", "matGauge" };
	...
	public void initGauges()
	{
	    ...
	    GaugeRegister.INSTANCE.addGauge(new GaugeDetails("fuelcompsn","fuelComposition",fuelComposition,"Ethanol Percentage","%",0,100,-1,-1,85,101,0,0,0));
	    GaugeRegister.INSTANCE.addGauge(new GaugeDetails("timingerrGauge","timing_err",timing_err,"Timing pred err","%",-127,127,255,255,255,0,0,0,0));
