...
public class ZZMS3_Pre11_alpha15 extends Megasquirt
{
	...
	public void initGauges()
	{
		...
		if (CYL_12_16_SUPPORT)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq9Gauge", "pwseq9", pwseq9, "Pulse Width Seq 9", "mSec",
					0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq10Gauge", "pwseq10", pwseq10, "Pulse Width Seq 10",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq11Gauge", "pwseq11", pwseq11, "Pulse Width Seq 11",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq12Gauge", "pwseq12", pwseq12, "Pulse Width Seq 12",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq13Gauge", "pwseq13", pwseq13, "Pulse Width Seq 13",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq14Gauge", "pwseq14", pwseq14, "Pulse Width Seq 14",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq15Gauge", "pwseq15", pwseq15, "Pulse Width Seq 15",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq16Gauge", "pwseq16", pwseq16, "Pulse Width Seq 16",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
		}
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq9Gauge", "pwseq9", pwseq9, "Pulse Width V3 inj1",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidthSeq10Gauge", "pwseq10", pwseq10, "Pulse Width V3 inj2",
					"mSec", 0, 25.5, 1.0, 1.2, 20, 25, 3, 1, 0));
		}
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("boostdutyGauge", "boostduty", boostduty, "Boost Duty", "%", 0, 100, -1,
				-1, 100, 100, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("boostdutyGauge2", "boostduty2", boostduty2, "Boost Duty 2", "%", 0, 100,
				-1, -1, 100, 100, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("injtimingpriGauge", "inj_timing_pri", inj_timing_pri,
				"Injector timing (pri)", "degrees", 0, 50, -1, -1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("injtimingsecGauge", "inj_timing_sec", inj_timing_sec,
				"Injector timing (sec)", "degrees", 0, 50, -1, -1, 999, 999, 1, 1, 0));
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("duty_pwm_f", "duty_pwm_f", duty_pwm_f, "Generic PWM F Duty", "%", 0, 100,
				100, 100, 100, 100, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvt_duty1", "vvt_duty1", vvt_duty1, "VVT 1 duty", "%", 0, 100, 100, 100,
				100, 100, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvt_duty2", "vvt_duty2", vvt_duty2, "VVT 2 duty", "%", 0, 100, 100, 100,
				100, 100, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvt_duty3", "vvt_duty3", vvt_duty3, "VVT 3 duty", "%", 0, 100, 100, 100,
				100, 100, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvt_duty4", "vvt_duty4", vvt_duty4, "VVT 4 duty", "%", 0, 100, 100, 100,
				100, 100, 1, 1, 0));
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("mapdot", "mapDOT", mapDOT, "mapdot", "kPa/sec", -15000, 15000, 65535,
				65535, 65535, 65535, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvttargGauge1", "vvt_target1", vvt_target1, "VVT 1 target", "degrees", 0,
				50, -1, -1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvttargGauge2", "vvt_target2", vvt_target2, "VVT 2 target", "degrees", 0,
				50, -1, -1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvttargGauge3", "vvt_target3", vvt_target3, "VVT 3 target", "degrees", 0,
				50, -1, -1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvttargGauge4", "vvt_target4", vvt_target4, "VVT 4 target", "degrees", 0,
				50, -1, -1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("fuelflowGauge", "fuelflow", fuelflow, "Fuel flow", "cc/min", 0, 65535,
				-1, -1, 99999, 99999, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("economy_l_km", "economy_l_km", economy_l_km, "Fuel economy", "l/km", 0,
				3, -1, -1, 9, 9, 2, 2, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("economy_mpg_us", "economy_mpg_us", economy_mpg_us, "Fuel economy",
				"mpg_us", 0, 60, -1, -1, 99, 99, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("economy_mpg_uk", "economy_mpg_uk", economy_mpg_uk, "Fuel economy",
				"mpg_uk", 0, 60, -1, -1, 99, 99, 0, 0, 0));
		if (CELSIUS)
		{
			...
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge12", "egt12", egt12, "EGT 12", "C", 0, 1250, 0, 0, 1250,
					1250, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge13", "egt13", egt13, "EGT 13", "C", 0, 1250, 0, 0, 1250,
					1250, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge14", "egt14", egt14, "EGT 14", "C", 0, 1250, 0, 0, 1250,
					1250, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge15", "egt15", egt15, "EGT 15", "C", 0, 1250, 0, 0, 1250,
					1250, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge16", "egt16", egt16, "EGT 16", "C", 0, 1250, 0, 0, 1250,
					1250, 0, 0, 0));
		}
		else
		{
			...
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge12", "egt12", egt12, "EGT 12", "F", 0, 2280, 0, 0, 2280,
					2280, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge13", "egt13", egt13, "EGT 13", "F", 0, 2280, 0, 0, 2280,
					2280, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge14", "egt14", egt14, "EGT 14", "F", 0, 2280, 0, 0, 2280,
					2280, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge15", "egt15", egt15, "EGT 15", "F", 0, 2280, 0, 0, 2280,
					2280, 0, 0, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egtGauge16", "egt16", egt16, "EGT 16", "F", 0, 2280, 0, 0, 2280,
					2280, 0, 0, 0));
		}
		if (CELSIUS)
		{
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("boostpsigGauge", "boostpsig", boostpsig, "Boost", "psig", -14.7, 21, -15,
				-15, 30, 30, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("knockinGauge", "knock", knock, "Knock Input", "%", 0, 100.0, -1, -1,
				100.0, 100.0, 1, 1, 0));
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("accelz", "accelz", accelz, "Accel Z", "ms-2", -59, 59, 59, 59, 59, 59, 2,
				2, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvtGauge1", "vvt_ang1", vvt_ang1, "VVT 1 angle", "degrees", 0, 50, -1,
				-1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvtGauge2", "vvt_ang2", vvt_ang2, "VVT 2 angle", "degrees", 0, 50, -1,
				-1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvtGauge3", "vvt_ang3", vvt_ang3, "VVT 3 angle", "degrees", 0, 50, -1,
				-1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("vvtGauge4", "vvt_ang4", vvt_ang4, "VVT 4 angle", "degrees", 0, 50, -1,
				-1, 999, 999, 1, 1, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("fuelcompsn", "fuel_pct", fuel_pct, "Ethanol Percentage", "%", 0, 100, -1,
				-1, 85, 101, 0, 0, 0));
		if (CELSIUS)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("fueltempGauge", "fuel_temp", fuel_temp, "Fuel Temp", "°C", -40, 110,
					-100, -100, 95, 105, 0, 0, 0));
		}
		else
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("fueltempGauge", "fuel_temp", fuel_temp, "Fuel Temp", "°F", -40, 240,
					-100, -100, 200, 220, 0, 0, 0));
		}
		if (NARROW_BAND_EGO)
		{
		...
		if (CYL_12_16_SUPPORT)
		{
			...
			{
				GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afr9Gauge", "afr9", afr9, "Air:Fuel Ratio 9", "", 10, 19.4, 12,
						13, 15, 16, 2, 2, 0));
				GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afr10Gauge", "afr10", afr10, "Air:Fuel Ratio 10", "", 10, 19.4,
						12, 13, 15, 16, 2, 2, 0));
				GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afr11Gauge", "afr11", afr11, "Air:Fuel Ratio 11", "", 10, 19.4,
						12, 13, 15, 16, 2, 2, 0));
				GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afr12Gauge", "afr12", afr12, "Air:Fuel Ratio 12", "", 10, 19.4,
						12, 13, 15, 16, 2, 2, 0));
				GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afr13Gauge", "afr13", afr13, "Air:Fuel Ratio 13", "", 10, 19.4,
						12, 13, 15, 16, 2, 2, 0));
				GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afr14Gauge", "afr14", afr14, "Air:Fuel Ratio 14", "", 10, 19.4,
						12, 13, 15, 16, 2, 2, 0));
				GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afr15Gauge", "afr15", afr15, "Air:Fuel Ratio 15", "", 10, 19.4,
						12, 13, 15, 16, 2, 2, 0));
				GaugeRegister.INSTANCE.addGauge(new GaugeDetails("afr16Gauge", "afr16", afr16, "Air:Fuel Ratio 16", "", 10, 19.4,
						12, 13, 15, 16, 2, 2, 0));
			}
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoV9Gauge", "egov9", egov9, "Exhaust Gas Oxygen 9", "volts", 0, 5,
					5, 5, 5, 5, 2, 2, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoV10Gauge", "egov10", egov10, "Exhaust Gas Oxygen 10", "volts", 0,
					5, 5, 5, 5, 5, 2, 2, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoV11Gauge", "egov11", egov11, "Exhaust Gas Oxygen 11", "volts", 0,
					5, 5, 5, 5, 5, 2, 2, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoV12Gauge", "egov12", egov12, "Exhaust Gas Oxygen 12", "volts", 0,
					5, 5, 5, 5, 5, 2, 2, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoV13Gauge", "egov13", egov13, "Exhaust Gas Oxygen 13", "volts", 0,
					5, 5, 5, 5, 5, 2, 2, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoV14Gauge", "egov14", egov14, "Exhaust Gas Oxygen 14", "volts", 0,
					5, 5, 5, 5, 5, 2, 2, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoV15Gauge", "egov15", egov15, "Exhaust Gas Oxygen 15", "volts", 0,
					5, 5, 5, 5, 5, 2, 2, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoV16Gauge", "egov16", egov16, "Exhaust Gas Oxygen 16", "volts", 0,
					5, 5, 5, 5, 5, 2, 2, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge9", "egocor9", egocor9, "EGO Correction 9", "%", 50, 150,
					90, 99, 101, 110, 1, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge10", "egocor10", egocor10, "EGO Correction 10", "%", 50,
					150, 90, 99, 101, 110, 1, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge11", "egocor11", egocor11, "EGO Correction 11", "%", 50,
					150, 90, 99, 101, 110, 1, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge12", "egocor12", egocor12, "EGO Correction 12", "%", 50,
					150, 90, 99, 101, 110, 1, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge13", "egocor13", egocor13, "EGO Correction 13", "%", 50,
					150, 90, 99, 101, 110, 1, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge14", "egocor14", egocor14, "EGO Correction 14", "%", 50,
					150, 90, 99, 101, 110, 1, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge15", "egocor15", egocor15, "EGO Correction 15", "%", 50,
					150, 90, 99, 101, 110, 1, 1, 0));
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("egoCorrGauge16", "egocor16", egocor16, "EGO Correction 16", "%", 50,
					150, 90, 99, 101, 110, 1, 1, 0));
		}
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("status5Gauge", "status5", status5, "Status 5", "", 0, 65535, 65535,
				65535, 65535, 65535, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("injcountGauge", "status5", status5, "Injection Count", "pulses", 0, 1000,
				65535, 65535, 65535, 65535, 0, 0, 0));
