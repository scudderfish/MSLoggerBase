 ...
 */
public class ZZMS2ExtraSerialGS26 extends Megasquirt
{
    public ZZMS2ExtraSerialGS26(Context c)
    {
        super(c);
        refreshFlags();
    }
    ...
    double vacuum;
    int nSquirts2;
    double pwmidle_cl_initialvalue_matorclt_follower;
    int nSquirts1;
    double lambda2;
    double lambda1;
    int secl;
    int rpm_target_error_follower;
    double boostpsig;
    double batt_targ_follower;
    double egoVoltage;
    ...
    int flats_arm;
    double N2O2PWHi;
    int idleadvance_cl_cond;
    int can_poll_id;
    int idle_up_off_countdown;
    int dualTable;
    int f5_0_tss_opt;
    int userlevel;
    int egoport;
    ...
    int pwmidle_cl_opts_initval_clt;
    double tps_persistance;
    int can_poll;
    int spk_conf2_gm;
    int boost_ctl_Ki;
    int mycan_id;
    ...
    double egoLimit;
    double IACtstep;
    int pwmidle_cl_opts_initvaluetable;
    int hybrid_rpm;
    int pwmidle_dp_decay_factor;
    double injPwmT;
    int port1_type;
    int taeColdM;
    ...
    int tss_rpm;
    double N2Odel_flat;
    int can_bcast1_280x4;
    int can_bcast1_280x1;
    int RevLimOption;
    int AMCstep;
    int crankTolerance;
    int user_value1;
