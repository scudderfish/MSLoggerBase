...
public class MS2Extra_Rel_201 extends Megasquirt
{
    public MS2Extra_Rel_201(Context c)
    {
        super(c);
        refreshFlags();
    }
...
//Constants
    ...
    public void initGauges()
    {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge6","egt6temp",egt6temp,"EGT","C",0,1000,0,0,1450,1480,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge7","egt7temp",egt7temp,"EGT","C",0,1000,0,0,1450,1480,1,1,45));
        }
        else
        {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge6","egt6temp",egt6temp,"EGT","F",0,2200,0,0,1450,1480,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge7","egt7temp",egt7temp,"EGT","F",0,2200,0,0,1450,1480,1,1,45));
        }
