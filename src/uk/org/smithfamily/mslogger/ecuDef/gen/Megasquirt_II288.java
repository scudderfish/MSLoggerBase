...
public class Megasquirt_II288 extends Megasquirt
{
    public Megasquirt_II288(Context c)
    {
        super(c);
        refreshFlags();
    }
    ...
    String signature = "MSII Rev 2.88000   \0";
...
//Constants
    ...
    public String getLogHeader()
    {
        ...
        b.append("XTau1").append("\t");
        b.append("XTau2").append("\t");
    ...
    public String getLogRow()
    {
        ...
        b.append(tachCount).append("\t");
        b.append(xTauFuelCorr1).append("\t");
        b.append(xTauFuelCorr2).append("\t");
    ...
    public void initGauges()
    {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","kpabaroGauge","kpaix",kpaix,"Engine MAP/baro","kPa",0,255,0,20,200,245,1,0,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","calcMapGauge","calcMAP",calcMAP,"Estimated MAP","kPa",0,255,0,20,200,245,1,0,45));
