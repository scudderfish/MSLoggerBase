...
//Variables
    ...
    private double batt_targ;
    private double batt_targ_follower;
    ...
    private int rpm_target_error_follower;
...
//Constants
    ...
    private int ClutchPIDEntry;
    private int rpm_window;
    ...
    private int idleadvance_cl_cond;
    private int can_poll_id;
    private int idle_up_off_countdown;
    ...
    private double tps_persistance;
    ...
    private int rpmLF;
    private int batLF;
    private int idle_up_options;
    private int OvrRunAndSpkC;
    private int seq_inj;
    private double AFRTarget;
    private int idle_up_options_tds;
    ...
    private int idle_up_options_input;
    ...
    private int bcor0;
    private int idle_up_options_avc;
    private double map0;
    private int egomult;
    private int AMCdve;
    private int egoKP;
    ...
    private int idle_up_options_zpr;
