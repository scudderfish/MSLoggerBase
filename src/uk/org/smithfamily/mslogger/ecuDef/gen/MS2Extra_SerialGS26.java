...
//Variables
    ...
    public double batt_targ;
    public double batt_targ_follower;
    ...
    public int rpm_target_error_follower;
...
//Constants
    ...
    public int ClutchPIDEntry;
    public int rpm_window;
    ...
    public int idleadvance_cl_cond;
    public int can_poll_id;
    public int idle_up_off_countdown;
    ...
    public int rpmLF;
    public int batLF;
    public int idle_up_options;
    public int OvrRunAndSpkC;
    public int seq_inj;
    public double AFRTarget;
    public int idle_up_options_tds;
    ...
    public int idle_up_options_input;
    ...
    public int bcor0;
    public int idle_up_options_avc;
    public double map0;
    public int egomult;
    public int AMCdve;
    public int egoKP;
    ...
    public int idle_up_options_zpr;
	...
	public void calculate(byte[] ochBuffer)
    {
        ...
        idleupcnt = (int)((MSUtils.getByte(ochBuffer,169) + 0.0) * 1.0);
        cl_idle_targ_rpm = (int)((MSUtils.getSignedWord(ochBuffer,170) + 0) * 1);
        ...
        rpm_target_error_follower = (rpm - cl_idle_targ_rpm);
        batt_targ_follower = (batteryVoltage - batt_targ);
        if (NARROW_BAND_EGO)
        {
        egoVoltage = (egoV);
        }
    ...
    public String getLogHeader()
    {
        ...
        b.append("idleupcnt").append("\t");
        b.append("cl_idle_targ_rpm").append("\t");
        b.append("Batt Targ").append("\t");
        b.append("rpm_target_error").append("\t");
        b.append("batt_targ_follower").append("\t");
    ...
    public String getLogRow()
    {
        ...
        b.append(idleupcnt).append("\t");
        b.append(cl_idle_targ_rpm).append("\t");
        b.append(round(batt_targ)).append("\t");
        b.append(rpm_target_error_follower).append("\t");
        b.append(batt_targ_follower).append("\t");
    ...
    public void initGauges()
    {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidth3Gauge","pulseWidth3",pulseWidth3,"Pulse Width 3","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidth4Gauge","pulseWidth4",pulseWidth4,"Pulse Width 4","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","injadv1Gauge","inj_adv1",inj_adv1,"Injection Timing 1","degrees",-360,360,-999,-999,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","injadv2Gauge","inj_adv2",inj_adv2,"Injection Timing 2","degrees",-360,360,-999,-999,999,999,1,1,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","gammaairGauge","airCorrection",airCorrection,"Gair/aircor","%",50,150,-1,-1,151,151,0,0,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vetrimGauge1","vetrim1curr",vetrim1curr,"VE Trim 1","%",87,113,-999,-999,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vetrimGauge2","vetrim2curr",vetrim2curr,"VE Trim 2","%",87,113,-999,-999,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vetrimGauge3","vetrim3curr",vetrim3curr,"VE Trim 3","%",87,113,-999,-999,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vetrimGauge4","vetrim4curr",vetrim4curr,"VE Trim 4","%",87,113,-999,-999,999,999,1,1,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","mapGauge","map",map,"Engine MAP","kPa",0,255,0,20,200,loadhigh,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","barometerGauge","barometer",barometer,"Barometer","kPa",60,120,0,20,120,120,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","fuelloadGauge","fuelload",fuelload,"Fuel Load","%",0,255,0,20,200,loadhigh,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","fuelload2Gauge","fuelload2",fuelload2,"Secondary Fuel Load","%",0,255,0,20,200,loadhigh,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","ignloadGauge","ignload",ignload,"Ign Load","%",0,255,0,20,200,loadhigh,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","ignload2Gauge","ignload2",ignload2,"Secondary Ign Load","%",0,255,0,20,200,loadhigh,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","eaeloadGauge","eaeload1",eaeload1,"EAE load","%",0,255,0,20,200,loadhigh,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afrloadGauge","afrload1",afrload1,"AFR load","%",0,255,0,20,200,loadhigh,1,0,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr1tgtGauge","afrtgt1",afrtgt1,"AFR1 target","",10,19.4,12,13,15,16,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr2tgtGauge","afrtgt2",afrtgt2,"AFR2 target","",10,19.4,12,13,15,16,2,2,45));
    ...
    public void loadConstants(boolean simulated)
    {
        ...
        mapsample_opt2 = MSUtils.getBits(pageBuffer,601,2,2,0);
        if (CELSIUS)
        {
        if (EXPANDED_CLT_TEMP)
        {
        ...
        cranking_matase = MSUtils.getBits(pageBuffer,611,2,2,0);
        ...
        batLF = (int)((MSUtils.getByte(pageBuffer,627) + 0.0) * 1.0);
        ...
        can_bcast1_on = MSUtils.getBits(pageBuffer,680,0,0,0);
        can_bcast1_280x4 = MSUtils.getBits(pageBuffer,680,1,1,0);
        can_bcast1_280x1 = MSUtils.getBits(pageBuffer,680,2,2,0);
        can_bcast1_289 = MSUtils.getBits(pageBuffer,680,3,3,0);
        can_bcast_int = (double)((MSUtils.getWord(pageBuffer,682) + 0.0) * 0.128);
        hw_latency = (double)((MSUtils.getWord(pageBuffer,730) + 0.0) * 0.66667);
        ...
        pwmidle_dp_decay_factor = (int)((MSUtils.getByte(pageBuffer,63) + 0.0) * 1.0);
        ...
        OvrRunAndSpkC = MSUtils.getBits(pageBuffer,828,7,7,0);
        ...
        idleadvance_on = MSUtils.getBits(pageBuffer,387,0,2,0);
        idleadvance_adder = MSUtils.getBits(pageBuffer,387,3,3,0);
        idleadvance_cl_cond = MSUtils.getBits(pageBuffer,387,4,4,0);
        idleadvance_aiv = MSUtils.getBits(pageBuffer,387,5,5,0);
        ...
        idle_up_options_zpr = MSUtils.getBits(pageBuffer,0,5,5,0);
        idle_up_options_tds = MSUtils.getBits(pageBuffer,0,6,6,0);
        idle_up_duty = (double)((MSUtils.getByte(pageBuffer,1) + 0.0) * 0.39063);
        idle_up_steps = (int)((MSUtils.getByte(pageBuffer,1) + 0.0) * 1.0);
        idle_up_targ_rpm = (int)((MSUtils.getWord(pageBuffer,2) + 0.0) * 1.0);
        idle_up_off_countdown = (int)((MSUtils.getByte(pageBuffer,4) + 0.0) * 1.0);
        idle_up_off_rate = (int)((MSUtils.getByte(pageBuffer,5) + 0.0) * 1.0);
        ClutchPIDEntry = MSUtils.getBits(pageBuffer,6,0,0,0);
        rpm_window = (int)((MSUtils.getByte(pageBuffer,7) + 0.0) * 1.0);
        batt_targ_window = (int)((MSUtils.getByte(pageBuffer,8) + 0.0) * 1.0);
        tps_persistance = (double)((MSUtils.getSignedWord(pageBuffer,9) + 0.0) * 0.128);
        pwmidle_cl_opts_initvaluetable = MSUtils.getBits(pageBuffer,65,0,0,0);
        pwmidle_cl_opts_initval_clt = MSUtils.getBits(pageBuffer,65,1,1,0);
        if (CELSIUS)
        {
        }
        else
