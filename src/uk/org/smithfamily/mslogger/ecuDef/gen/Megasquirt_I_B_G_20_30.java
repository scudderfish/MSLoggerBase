...
public class Megasquirt_I_B_G_20_30 extends Megasquirt
{
    public Megasquirt_I_B_G_20_30(Context c)
    {
        super(c);
        refreshFlags();
    }
...
//Constants
    ...
    public double taeBins1;
    public double taeBins2;
    public int nCylinders;
    public double taeBins3;
    public int tdePct;
    public int algorithm;
    public double injOpen;
    public double taeColdA;
    public double taeBins4;
    ...
    public void initGauges()
    {
        ...
        if (NARROW_BAND_EGO)
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoGauge","egoVoltage",egoVoltage,"Exhaust Gas Oxygen","volts",0,1.0,0.2,0.3,0.6,0.8,2,2,45));
        }
        else
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoGauge","egoVoltage",egoVoltage,"Exhaust Gas Oxygen","volts",0.5,4.5,0.0,0.0,5.0,5.0,2,2,45));
        }
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","dutyCycleGauge","dutyCycle",dutyCycle,"Duty Cycle","%",0,100,-1,-1,85,90,1,1,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthGauge","pulseWidth",pulseWidth,"Pulse Width","mSec",0,25.5,1.0,1.2,20,25,1,1,45));
        ...
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","cltGauge","coolant",coolant,"Coolant Temp","%TEMP",-40,250,0,30,200,220,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","matGauge","mat",mat,"Manifold Air Temp","%TEMP",-40,215,0,30,200,210,0,0,45));
        }
    }
