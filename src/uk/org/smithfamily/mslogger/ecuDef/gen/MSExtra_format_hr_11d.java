...
public class MSExtra_format_hr_11d extends Megasquirt
{
    public MSExtra_format_hr_11d(Context c)
    {
        super(c);
        refreshFlags();
    }
...
//Flags
    ...
    private boolean LOGPAGES;
    private boolean NARROW_BAND_EGO;
    private boolean KPa;
    private boolean ALPHA_N;
    private boolean MSLVV_COMPATIBLE;
...
//Variables
    ...
    private int InjectorRating1;
    private int InjectorRating2;
    ...
    private double Open_Time1;
    private double Open_Time2;
    ...
    private double dutyCy1Real;
    private double dutyCy2Real;
...
//Constants
    private double ALSRETARD1;
    private int whlsimcnt;
    private int fastIdleTemp;
    private int WaterIIat;
    private int TPSRPMTarg;
    private double ALSRETARD4;
    private double ALSRETARD3;
    private int out2src;
    private double ALSRETARD2;
    ...
    private int rpmk2;
    private double ALSRPM2;
    private double ictlrpm2;
    private double ALSRPM1;
    private int rpmk1;
    private double ictlrpm1;
    private double ALSRPM4;
    private int cltType2;
    private double ALSRPM3;
    ...
    private int out4lim;
    private int StagedMAP2nd;
    private double BaroLow;
    private int tdePct4;
    ...
    private int falsetrig_dis;
    private int ALSEnable;
    ...
    private int idledelayclock;
    private int NGC_test;
    ...
    private int NosTps;
    private int inj2t;
    private int idleclosedc;
    private int DtNos;
    private int idle_dc_lo;
    private int IgRetDeg;
    private double BaroHi;
    ...
    private int Idashdelay;
    private int inj1g;
    private int launchUse;
    private int tfi;
    private int idlestartclk;
    private int ALSRetard;
    private int freqDiv;
    private int idlecrankdc;
    ...
    private int Stg2ndParmKPA;
    private int ALSFUEL1;
    private int ALSFUEL2;
    private int ALSFUEL3;
    private int ALSFUEL4;
    ...
    public DataPacket getDataPacket()
    {
        ...
        fields.put("InjectorRating1",(double)InjectorRating1);
        fields.put("InjectorRating2",(double)InjectorRating2);
        ...
        fields.put("Open_Time1",(double)Open_Time1);
        fields.put("Open_Time2",(double)Open_Time2);
        fields.put("Radius",(double)Radius);
        fields.put("RpmHiRes",(double)RpmHiRes);
        fields.put("RpmHitmp",(double)RpmHitmp);
        ...
        fields.put("dutyCy1Real",(double)dutyCy1Real);
        fields.put("dutyCy2Real",(double)dutyCy2Real);
        ...
        fields.put("load_c",(double)load_c);
        ...
        fields.put("ramslot4",(double)ramslot4);
