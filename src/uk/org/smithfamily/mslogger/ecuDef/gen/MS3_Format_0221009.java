...
public class MS3_Format_0221009 extends Megasquirt
{
    public MS3_Format_0221009(Context c)
    {
        super(c);
        refreshFlags();
    }
...
//Constants
    ...
    public double map_min_accel_change;
    ...
    public double tps_min_accel_change;
