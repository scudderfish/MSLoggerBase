...
public class MS3_Format_0229002 extends Megasquirt
{
    public MS3_Format_0229002(Context c)
    {
        super(c);
        refreshFlags();
    }
    ...
    String signature = "MS3 Format 0229.002\0";
...
//Constants
    ...
    public double accel_mapdot_threshold;
    ...
    public void loadConstants(boolean simulated)
    {
        ...
        accel_mapdot_threshold = (double)((MSUtils.getWord(pageBuffer,140) + 0.0) * 0.1);
