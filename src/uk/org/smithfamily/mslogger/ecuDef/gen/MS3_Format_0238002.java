...
public class MS3_Format_0238002 extends Megasquirt
{
    public MS3_Format_0238002(Context c)
    {
        super(c);
        refreshFlags();
    }
...
//Defaults
    public String  tsCanId =  "CAN ID 0";
    public int  rpmhigh =  9000;
    public int  rpmwarn =  3000;
    public int  rpmdang =  5000;
    public int  loadhigh =  400;
//Variables
    ...
    public int cl_idle_targ_rpm;
    public int clt_exp;
    public int clthighdang;
    public int clthighlim;
    public int clthighwarn;
    public int cltlowdang;
    public int cltlowlim;
    public int cltlowwarn;
    ...
    public double economy_l_km;
    public double economy_mpg_uk;
    public double economy_mpg_us;
    ...
    public double fuel_pct;
    public double fuel_temp;
    public int fuelcons;
    public int fuelflow;
    ...
    public double knock_cyl01;
    public double knock_cyl02;
    public double knock_cyl03;
    public double knock_cyl04;
    public double knock_cyl05;
    public double knock_cyl06;
    public double knock_cyl07;
    public double knock_cyl08;
    public double knock_cyl09;
    public double knock_cyl10;
    public double knock_cyl11;
    public double knock_cyl12;
    public double knock_cyl13;
    public double knock_cyl14;
    public double knock_cyl15;
    public double knock_cyl16;
    ...
    public double pwmidle_cl_initialvalue_matorclt_follower;
    ...
    public double total_accel;
    public double tps;
    public int tpsADC;
    public double tpsDOT;
    public double tps_accel;
    ...
    public double vss1;
    public int vss1_real;
    public double vss1dot;
    public double vss2;
    public int vss2_real;
...
//Constants
    ...
    public double accel_tpsdot_threshold;
    ...
    public double accel_blend_percent;
    ...
    public int accel_mapdot_threshold;
    ...
    public int can_bcast1_280x4;
    public int egt2port;
    public int idleve_vsson;
    public int vvt_ctl_Kp;
    public int can_bcast1_280x1;
    ...
    public double accel_CLT_multiplier;
    ...
    public int pwmidle_cl_opts_initvaluetable;
    public int reluctorteeth3;
    public int enable_pollports_digin;
    public int pwmidle_dp_decay_factor;
    ...
    public int ss_opt1;
    public double flex_pct1;
    public double flex_pct0;
    ...
    public int idle_special_ops_timing_assist;
    ...
    public void initGauges()
    {
        ...
        if (CYL_12_16_SUPPORT)
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthSeq9Gauge","pwseq9",pwseq9,"Pulse Width Seq 9","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthSeq10Gauge","pwseq10",pwseq10,"Pulse Width Seq 10","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthSeq11Gauge","pwseq11",pwseq11,"Pulse Width Seq 11","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthSeq12Gauge","pwseq12",pwseq12,"Pulse Width Seq 12","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthSeq13Gauge","pwseq13",pwseq13,"Pulse Width Seq 13","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthSeq14Gauge","pwseq14",pwseq14,"Pulse Width Seq 14","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthSeq15Gauge","pwseq15",pwseq15,"Pulse Width Seq 15","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","pulseWidthSeq16Gauge","pwseq16",pwseq16,"Pulse Width Seq 16","mSec",0,25.5,1.0,1.2,20,25,3,1,45));
        }
        else
        {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","boostdutyGauge2","boostduty2",boostduty2,"Boost Duty 2","%",0,100,-1,-1,100,100,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","injtimingpriGauge","inj_timing_pri",inj_timing_pri,"Injector timing (pri)","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","injtimingsecGauge","inj_timing_sec",inj_timing_sec,"Injector timing (sec)","degrees",0,50,-1,-1,999,999,1,1,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvt_duty1","vvt_duty1",vvt_duty1,"VVT 1 duty","%",0,100,100,100,100,100,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvt_duty2","vvt_duty2",vvt_duty2,"VVT 2 duty","%",0,100,100,100,100,100,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvt_duty3","vvt_duty3",vvt_duty3,"VVT 3 duty","%",0,100,100,100,100,100,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvt_duty4","vvt_duty4",vvt_duty4,"VVT 4 duty","%",0,100,100,100,100,100,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","launch_timer","launch_timer",launch_timer,"Launch timer","s",0,15,15,15,15,15,3,3,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","launch_retard","launch_retard",launch_retard,"Launch timed retard","deg",-5,30,30,30,30,30,1,1,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","timingerrGauge","timing_err",timing_err,"Timing pred err","%",-127,127,255,255,255,255,0,0,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvttargGauge1","vvt_target1",vvt_target1,"VVT 1 target","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvttargGauge2","vvt_target2",vvt_target2,"VVT 2 target","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvttargGauge3","vvt_target3",vvt_target3,"VVT 3 target","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvttargGauge4","vvt_target4",vvt_target4,"VVT 4 target","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","fuelflowGauge","fuelflow",fuelflow,"Fuel flow","cc/min",0,65535,-1,-1,99999,99999,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","economy_l_km","economy_l_km",economy_l_km,"Fuel economy","l/km",0,3,-1,-1,9,9,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","economy_mpg_us","economy_mpg_us",economy_mpg_us,"Fuel economy","mpg_us",0,60,-1,-1,99,99,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","economy_mpg_uk","economy_mpg_uk",economy_mpg_uk,"Fuel economy","mpg_uk",0,60,-1,-1,99,99,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","tps_accel","tps_accel",tps_accel,"tps_accel","%/sec",-15000,15000,65535,65535,65535,65535,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","map_accel","map_accel",map_accel,"map_accel","kPa/sec",-15000,15000,65535,65535,65535,65535,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","total_accel","total_accel",total_accel,"total_accel","%/sec",-15000,15000,65535,65535,65535,65535,0,0,45));
        if (CELSIUS)
        {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge13","egt13",egt13,"EGT 13","C",0,1250,0,0,1250,1250,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge14","egt14",egt14,"EGT 14","C",0,1250,0,0,1250,1250,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge15","egt15",egt15,"EGT 15","C",0,1250,0,0,1250,1250,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge16","egt16",egt16,"EGT 16","C",0,1250,0,0,1250,1250,0,0,45));
        }
        else
        {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge13","egt13",egt13,"EGT 13","F",0,2280,0,0,2280,2280,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge14","egt14",egt14,"EGT 14","F",0,2280,0,0,2280,2280,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge15","egt15",egt15,"EGT 15","F",0,2280,0,0,2280,2280,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egtGauge16","egt16",egt16,"EGT 16","F",0,2280,0,0,2280,2280,0,0,45));
        }
        if (CELSIUS)
        {
        if (EXPANDED_CLT_TEMP)
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","tachometer","rpm",rpm,"Engine Speed","RPM",0,rpmhigh,300,600,rpmwarn,rpmdang,0,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","throttleGauge","throttle",throttle,"Throttle Position","%",0,100,-1,1,90,100,1,0,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","mafGauge","maf",maf,"Mass Air Flow","g/sec",0,650,0,200,480,550,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","mafMapGauge","mafmap",mafmap,"MAFMAP","kPa",0,400,-1,-1,999,999,1,0,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","boostvacGauge","boostvac",boostvac,"Vac/Boost","inHg/psig",-30,30,-30,-30,30,30,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knockinGauge","knock",knock,"Knock Input","%",0,100.0,-1,-1,100.0,100.0,1,1,45));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvtGauge1","vvt_ang1",vvt_ang1,"VVT 1 angle","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvtGauge2","vvt_ang2",vvt_ang2,"VVT 2 angle","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvtGauge3","vvt_ang3",vvt_ang3,"VVT 3 angle","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","vvtGauge4","vvt_ang4",vvt_ang4,"VVT 4 angle","degrees",0,50,-1,-1,999,999,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","fuelcompsn","fuel_pct",fuel_pct,"Ethanol Percentage","%",0,100,-1,-1,85,101,0,0,45));
        if (CELSIUS)
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","fueltempGauge","fuel_temp",fuel_temp,"Fuel Temp","°C",-40,110,-100,-100,95,105,0,0,45));
        }
        else
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","fueltempGauge","fuel_temp",fuel_temp,"Fuel Temp","°F",-40,240,-100,-100,200,220,0,0,45));
        }
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock01Gauge","knock_cyl01",knock_cyl01,"Knock cyl# 1","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock02Gauge","knock_cyl02",knock_cyl02,"Knock cyl# 2","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock03Gauge","knock_cyl03",knock_cyl03,"Knock cyl# 3","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock04Gauge","knock_cyl04",knock_cyl04,"Knock cyl# 4","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock05Gauge","knock_cyl05",knock_cyl05,"Knock cyl# 5","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock06Gauge","knock_cyl06",knock_cyl06,"Knock cyl# 6","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock07Gauge","knock_cyl07",knock_cyl07,"Knock cyl# 7","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock08Gauge","knock_cyl08",knock_cyl08,"Knock cyl# 8","",0,100,0,0,100,100,1,0,45));
        if (CYL_12_16_SUPPORT)
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock09Gauge","knock_cyl09",knock_cyl09,"Knock cyl# 9","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock10Gauge","knock_cyl10",knock_cyl10,"Knock cyl#10","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock11Gauge","knock_cyl11",knock_cyl11,"Knock cyl#11","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock12Gauge","knock_cyl12",knock_cyl12,"Knock cyl#12","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock13Gauge","knock_cyl13",knock_cyl13,"Knock cyl#13","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock14Gauge","knock_cyl14",knock_cyl14,"Knock cyl#14","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock15Gauge","knock_cyl15",knock_cyl15,"Knock cyl#15","",0,100,0,0,100,100,1,0,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","knock16Gauge","knock_cyl16",knock_cyl16,"Knock cyl#16","",0,100,0,0,100,100,1,0,45));
        }
        if (NARROW_BAND_EGO)
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV1Gauge","egov1",egov1,"Exhaust Gas Oxygen 1","volts",0,1,1,1,1,1,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV2Gauge","egov2",egov2,"Exhaust Gas Oxygen 2","volts",0,1,1,1,1,1,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV3Gauge","egov3",egov3,"Exhaust Gas Oxygen 3","volts",0,1,1,1,1,1,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV4Gauge","egov4",egov4,"Exhaust Gas Oxygen 4","volts",0,1,1,1,1,1,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV5Gauge","egov5",egov5,"Exhaust Gas Oxygen 5","volts",0,1,1,1,1,1,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV6Gauge","egov6",egov6,"Exhaust Gas Oxygen 6","volts",0,1,1,1,1,1,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV7Gauge","egov7",egov7,"Exhaust Gas Oxygen 7","volts",0,1,1,1,1,1,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV8Gauge","egov8",egov8,"Exhaust Gas Oxygen 8","volts",0,1,1,1,1,1,2,2,45));
        }
        else if (LAMBDA)
        {
        ...
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr9Gauge","afr9",afr9,"Air:Fuel Ratio 9","",10,19.4,12,13,15,16,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr10Gauge","afr10",afr10,"Air:Fuel Ratio 10","",10,19.4,12,13,15,16,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr11Gauge","afr11",afr11,"Air:Fuel Ratio 11","",10,19.4,12,13,15,16,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr12Gauge","afr12",afr12,"Air:Fuel Ratio 12","",10,19.4,12,13,15,16,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr13Gauge","afr13",afr13,"Air:Fuel Ratio 13","",10,19.4,12,13,15,16,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr14Gauge","afr14",afr14,"Air:Fuel Ratio 14","",10,19.4,12,13,15,16,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr15Gauge","afr15",afr15,"Air:Fuel Ratio 15","",10,19.4,12,13,15,16,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","afr16Gauge","afr16",afr16,"Air:Fuel Ratio 16","",10,19.4,12,13,15,16,2,2,45));
        }
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV9Gauge","egov9",egov9,"Exhaust Gas Oxygen 9","volts",0,5,5,5,5,5,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV10Gauge","egov10",egov10,"Exhaust Gas Oxygen 10","volts",0,5,5,5,5,5,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV11Gauge","egov11",egov11,"Exhaust Gas Oxygen 11","volts",0,5,5,5,5,5,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV12Gauge","egov12",egov12,"Exhaust Gas Oxygen 12","volts",0,5,5,5,5,5,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV13Gauge","egov13",egov13,"Exhaust Gas Oxygen 13","volts",0,5,5,5,5,5,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV14Gauge","egov14",egov14,"Exhaust Gas Oxygen 14","volts",0,5,5,5,5,5,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV15Gauge","egov15",egov15,"Exhaust Gas Oxygen 15","volts",0,5,5,5,5,5,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoV16Gauge","egov16",egov16,"Exhaust Gas Oxygen 16","volts",0,5,5,5,5,5,2,2,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoCorrGauge9","egocor9",egocor9,"EGO Correction 9","%",50,150,90,99,101,110,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoCorrGauge10","egocor10",egocor10,"EGO Correction 10","%",50,150,90,99,101,110,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoCorrGauge11","egocor11",egocor11,"EGO Correction 11","%",50,150,90,99,101,110,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoCorrGauge12","egocor12",egocor12,"EGO Correction 12","%",50,150,90,99,101,110,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoCorrGauge13","egocor13",egocor13,"EGO Correction 13","%",50,150,90,99,101,110,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoCorrGauge14","egocor14",egocor14,"EGO Correction 14","%",50,150,90,99,101,110,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoCorrGauge15","egocor15",egocor15,"EGO Correction 15","%",50,150,90,99,101,110,1,1,45));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","egoCorrGauge16","egocor16",egocor16,"EGO Correction 16","%",50,150,90,99,101,110,1,1,45));
        }
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","injcountGauge","status5",status5,"Injection Count","pulses",0,1000,65535,65535,65535,65535,0,0,45));
