...
/*
Fingerprint : 467481a1a9132d83d96963463fcbb1bf
*/
@SuppressWarnings("unused")
public class MS2Extra_Serial330e extends Megasquirt
{
    public MS2Extra_Serial330e(Context c)
    {
        super(c);
        refreshFlags();
    }
    ...
    String signature = "MS2Extra Serial330e\0";
    byte [] ochGetCommand = new byte[]{'A'};
    int ochBlockSize = 172;
//Flags
...
//Constants
    ...
    public void loadConstants(boolean simulated)
    {
        ...
        pidrpm_window = (int)((MSUtils.getByte(pageBuffer,7) + 0.0) * 1.0);
        batdeltaLF = (int)((MSUtils.getByte(pageBuffer,113) + 0.0) * 1.0);
