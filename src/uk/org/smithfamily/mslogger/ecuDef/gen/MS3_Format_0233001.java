...
public class MS3_Format_0233001 extends Megasquirt
{
    public MS3_Format_0233001(Context c)
    {
        super(c);
        refreshFlags();
    }
    ...
    String signature = "MS3 Format 0233.001\0";
...
//Constants
    ...
    public void initGauges()
    {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("Gauge","","tachometer","rpm",rpm,"Engine Speed","RPM",0,rpmhigh,300,600,3000,5000,0,0,45));
