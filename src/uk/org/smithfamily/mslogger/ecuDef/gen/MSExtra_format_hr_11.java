...
//Constants
    ...
    public void initGauges()
    {
        ...
        if (MPXH6300A)
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("loadGauge","engineLoad",engineLoad,"Load"," % ",0,304,0,20,250,275,0,0,45));
        }
        else if (MPXH6400A)
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("loadGauge","engineLoad",engineLoad,"Load"," % ",0,400,0,20,300,375,0,0,45));
        }
        else
        {
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("loadGauge","engineLoad",engineLoad,"Load"," % ",0,255,0,20,200,245,0,0,45));
        }
    }
    ...
    public DataPacket getDataPacket()
    {
        ...
        fields.put("engineLoad",(double)engineLoad);
