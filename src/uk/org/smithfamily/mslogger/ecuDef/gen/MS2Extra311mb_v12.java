...
//Defaults
//Variables
    public double EAEFuelCorr1;
    public double EAEFuelCorr2;
...
//Constants
    ...
    public int pwmidle_pid_stallrpm;
    public int N2O2RpmMax;
    public int knkpull;
    public int asTolerance;
    public int rpmLF;
    public int seq_inj;
    public double pwmidle_pid_duty_tolerance;
    public double AFRTarget;
    public int knkport_remote;
    public int pwmidle_pid_steps_tolerance;
