 ...
 */
public class ZZMegasquirt_II286 extends Megasquirt
{
    public ZZMegasquirt_II286(Context c)
    {
        super(c);
        refreshFlags();
    }
    ...
    private Set<String> sigs          = new HashSet<String>(Arrays.asList(new String[] { signature, "MSII Rev 2.88000   \0", "MSII Rev 2.88600   \0" }));
    // Flags
    boolean             n2o;
    ...
    private String[]    defaultGauges = { "tachometer", "throttleGauge", "pulseWidth1Gauge", "egoGauge", "lambda1Gauge", "afr1Gauge", "mapGauge", "IACgauge", "PWMIdlegauge", "matGauge", "xTauGauge1", "advdegGauge", "dwellGauge" };
    ...
    public void initGauges()
    {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("kpabaroGauge", "kpaix", kpaix, "Engine MAP/baro", "kPa", 0, 255, 0, 20, 200, 245, 1, 0, 0));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("calcMapGauge", "calcMAP", calcMAP, "Estimated MAP", "kPa", 0, 255, 0, 20, 200, 245, 1, 0, 0));
    ...
    public void loadConstants(boolean simulated)
    {
        ...
        pageBuffer = loadPage(2, 0, 946, null, new byte[] { 114, 3, -78, 0, 0, 3, -78 });
