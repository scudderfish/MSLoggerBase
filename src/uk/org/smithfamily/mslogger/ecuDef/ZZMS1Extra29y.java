...
public class ZZMS1Extra29y extends Megasquirt
{
    ...
    public void initGauges()
    {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidth1Gauge", "pulseWidth1", pulseWidth1, "Pulse Width 1", "mSec", 0, 25.5, 1.0, 1.2, 20, 25, 1, 1, 0));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("pulseWidth2Gauge", "pulseWidth2", pulseWidth2, "Pulse Width 2", "mSec", 0, 25.5, 1.0, 1.2, 20, 25, 1, 1, 0));
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails("advanceGauge", "advSpark", advSpark, "Spark Advance", "deg BTDC", 50, -10, 0, 0, 35, 45, 1, 0, 0));
