...
public class MS2Extra210 extends Megasquirt
{
	...
	public void initGauges()
	{
		...
		if (CELSIUS)
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("cltGauge", "coolant", "Coolant Temp", "°C", -40, 230, -100, -100,
					170, 200, 0, 0, 0));
		...
		{
			GaugeRegister.INSTANCE.addGauge(new GaugeDetails("cltGauge", "coolant", "Coolant Temp", "°F", -40, 450, -100, -100,
					350, 400, 0, 0, 0));
		...
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("gpioadc7Gauge", "gpioadc7", "GPIO ADC 7", "", 0, 1023, 1023, 1023, 1023,
				1023, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dbgcrkmaskGauge", "dbg_crk_mask", "Crank masked", "", 0, 255, 255, 255,
				255, 255, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dbgcrkfiltGauge", "dbg_crk_filt", "Crank filtered", "", 0, 255, 255, 255,
				255, 255, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dbgcammaskGauge", "dbg_cam_mask", "Cam masked", "", 0, 255, 255, 255,
				255, 255, 0, 0, 0));
		GaugeRegister.INSTANCE.addGauge(new GaugeDetails("dbgcamfiltGauge", "dbg_cam_filt", "Cam filtered", "", 0, 255, 255, 255,
				255, 255, 0, 0, 0));
