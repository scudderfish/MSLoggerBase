...
public class ZZMS3_Format_0095002_102 extends Megasquirt
{
    ...
    public void initGauges()
    {
        ...
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails(";   accelx", "accelx", accelx, "Accel X", "g", -6, 6, 6, 6, 6, 6, 3, 3, 0));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails(";   accely", "accely", accely, "Accel Y", "g", -6, 6, 6, 6, 6, 6, 3, 3, 0));
        GaugeRegister.INSTANCE.addGauge(new GaugeDetails(";   accelz", "accelz", accelz, "Accel Z", "g", -6, 6, 6, 6, 6, 6, 3, 3, 0));
        if (NARROW_BAND_EGO)
        {
        }
        else if (LAMBDA)
