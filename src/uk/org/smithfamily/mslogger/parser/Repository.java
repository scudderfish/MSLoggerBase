...
import uk.org.smithfamily.mslogger.parser.log.DatalogEntry;
import uk.org.smithfamily.mslogger.parser.log.DatalogList;
import uk.org.smithfamily.mslogger.parser.log.DatalogOptions;
            ...
            while ((lineBuffer = in.readLine()) != null)
            {
                ...
                case blockConstants: // ------------------------------------------------
                    ...
                    if (t.get(0).equals(StringConstants.S_burnCommand))
                    {
                        ...
                        for (int i = 0; i < nT - 1; i++)
                        {
                            String cmd = t.get(i + 1);
                            mdb.cDesc.setBurnCommand(cmd, i);
                        }
                        break;
                    }
                    if (t.get(0).equals(StringConstants.S_pageActivate))
                    {
                        ...
                        {
                            String cmd = t.get(i + 1);
                            mdb.cDesc.setPageActivate(cmd, i);
                        }
                        break;
                    }
                    if (t.get(0).equals(StringConstants.S_pageIdentifier))
                    {
                        ...
                        {
                            String cmd = t.get(i + 1);
                            mdb.cDesc.setPageIdentifier(cmd, i);
                        }
                        break;
                    }
                    ...
                    { // == Read commands ==
                        ...
                        {
                            String cmd = t.get(i + 1);
                            mdb.cDesc.setPageReadWhole(cmd, i);
                        }
                        break;
                    }
