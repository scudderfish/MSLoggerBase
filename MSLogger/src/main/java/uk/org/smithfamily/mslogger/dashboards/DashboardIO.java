...
public enum DashboardIO
{
    ...
    private List<Dashboard> activeDashboardDefinitions = new ArrayList<>();
    private final Map<String, List<Dashboard>> dashCache = new HashMap<>();
    ...
    public synchronized List<Dashboard> loadDash(String dashName)
    {
        ...
        {
            activeDashboardDefinitions = new ArrayList<>();
            try
            {
                dashName += ".json";
    ...
    private Location createLocation(final JSONObject jLocation) {
