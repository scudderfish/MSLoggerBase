 ...
 */
@SuppressWarnings({"ResultOfMethodCallIgnored", "SynchronizeOnNonFinalField"})
public enum DebugLogManager
{
    ...
    private void createLogFile() throws IOException
    {
        ...
        // (1024 * 5)B = 5120KB = 5MB
        int MAX_LOG_FILE_SIZE_THRESHOLD = 5120;
    ...
    public void log(final String msg, final byte[] result, final int logLevel)
    {
        ...
        final StringBuilder b = new StringBuilder(msg).append("\n");
